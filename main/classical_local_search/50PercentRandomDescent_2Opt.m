...
%calculate the improvements acheived by 50% combination of 2-opt and pick the best amongst them
for cl=1:k
    BestImp=-1;
    New_PRD = TSP_FI{cl};
    TSP_PRD = TSP_FI{cl};
    ...
    if (TSP_SizePRD > 4)
        while (BestImp<0)
            ...
            % Percentage:50%
            Nb_neighbor = round(0.5*Nb_possible_swaps);
